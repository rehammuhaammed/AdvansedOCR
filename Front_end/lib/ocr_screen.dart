...
class _OcrScreenState extends State<OcrScreen> {
  ...
  List<String> _fontSizes = ['Small', 'Medium', 'Large', 'Extra Large'];
  String _fontSizeSelection = 'Medium'; // Default selection

  bool isLoad = false;
  String ngrokBaseUrl = 'https://15cc-197-46-246-212.ngrok-free.app';
    ...
    File? croppedFile = await ImageCropper().cropImage(
      ...
      androidUiSettings: AndroidUiSettings(
        ...
        toolbarColor: _isDarkMode
            ...
            : Colors.deepPurple.shade300, // Light mode toolbar color
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text('Font Style:', style: TextStyle(color: Colors.black87)),
                Wrap(
                  spacing: 10,
                    ...
                    return ElevatedButton(
                      ...
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all<Color>(
                            _isDarkMode
                                ? Colors.deepPurple
                                    .shade700 // Dark mode button color
                                : Colors.deepPurpleAccent
                                    .shade400), // Light mode button color
                      ),
                    );
                  }).toList(),
                ),
                SizedBox(height: 20),
                Text('Font Family:', style: TextStyle(color: Colors.black87)),
                Wrap(
                  spacing: 10,
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _fontSizes.map((String size) {
                  ...
                  onChanged: (String? newValue) {
                    setState(() {
                      _fontSizeSelection = newValue!;
                      _updateFontSize(
                          newValue); // Implement a method to update font size based on selection
                    });
                  },
                ...
                Row(
                  ...
                  children: [
                    Text('Dark Mode', style: TextStyle(color: Colors.black87)),
                    Switch(
                      value: _isDarkMode,
  ...
  void _updateFontSize(String size) {
    switch (size) {
      ...
      default:
        setState(() {
          _fontSize = 16.0; // Default to medium if selection is unknown
        });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('InstaText'),
        centerTitle: true,
        elevation: 0,
        backgroundColor: _isDarkMode
            ? Colors.deepPurple.shade700 // Dark mode app bar color
            : Colors.deepPurple.shade300, // Light mode app bar color
        actions: [
          IconButton(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontFamily: _fontFamily, // Apply selected font family
